                ...
                <div className='flex flex-col lg:flex-row items-center justify-evenly px-4'>
                    <div className='flex justify-center gap-10 px-4 mb-8'>
                        <ul className='cursor-pointer'>
                            <li className='py-2 font-semibold'>{t("footerContact")}</li>
                            <a className='flex items-center justify-start gap-2 text-[#777676] py-2'><span className='w-[20px]'><img src={phone} alt="phone" className='mx-auto' /></span>{t("footerNumber")}</a>
                            <a className='flex items-center justify-start gap-2 text-[#777676] py-2'><span className='w-[20px]'><img src={time} alt="phone" className='mx-auto' /></span>{t("footerTime")}</a>
                            <a className='flex items-center justify-start gap-2 text-[#777676] py-2'><span className='w-[20px]'><img src={location} alt="phone" className='mx-auto' /></span>{t("footerLocate")}</a>
                        </ul>
                        <ul className='cursor-pointer'>
                            <li className='py-2 font-semibold'>{t("footerSocial")}</li>
