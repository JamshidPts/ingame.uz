    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-[#0F0F0F] p-10 shadow-lg max-w-[350px] sm:max-w-[500px] relative">
                ...
                <h5 className="text-white text-center text-[20px] sm:text-[25px] font-bold"><span className="text-[#D3176D]">{t("ModalTitle")}</span> {t("ModalSubtitle")}</h5>
                ...
                <p className="text-[#D3176D] text-center font-bold text-[18px] sm:text-[22px] max-w-[250px] sm:max-w-[300px] mx-auto">{t("ModalLink")} <a href="" className="text-white border-b border-b-white ">Telegram</a></p>
            </div>
        </div>
    )
}
